...
class Stock(models.Model):
    ...
    def get_new_move_line(self, vals, qty_done, default_code, sequence, origin, index):
        vals['qty_done'] = qty_done
        default_code = 'LT-%s-%s-'%(origin or '', default_code or '')
    ...
    def onchange_lots_count(self):
        ...
        if lots_count:
            ...
            # picking_origin = self.picking_id.origin
            picking_origin = self.picking_id.purchase_id.name
            ...
            for index in range(1, lots_count+1):
                ...
                if index == lots_count and lots_lets:
                    lots_co += lots_lets
                move_line = self.get_new_move_line(vals, lots_co, default_code, lots_sequence, picking_origin, index)
